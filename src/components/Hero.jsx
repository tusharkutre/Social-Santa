...
export default function Hero({ toggleDarkMode, isDarkMode }) {
  ...
  return (
    <>
      <header className="relative overflow-visible inset-x-0">
        <nav
          aria-label="Global"
        ...
        >
          <div className="flex  lg:flex-1">
            <a href="#" className="flex items-center flex-row-reverse gap-2">
              <h2 className="text-2xl font-medium hidden md:block">Social Santa</h2>
              <svg
                width="40"
                height="40"
                viewBox="0 0 49 40"
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className={`text-md font-semibold ${isDarkMode ? " text-white hover:bg-white hover:text-black px-2 py-2 rounded-2xl" : "text-black hover:bg-black hover:text-white px-2 py-2 rounded-2xl"} `}
              >
                {item.name}
              </a>
            ))}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full font-medium px-3 py-1 text-md text-gray-400 ring-2 ring-gray-900/10 hover:ring-gray-900/20">
          ...
          <div className="text-center">
            ...
            Our platform ensures swift, secure, and seamless delivery, empowering businesses to reach customers with ease.
            </p>
